...
public class MyActivity3 extends Activity  implements GoogleApiClient.ConnectionCallbacks, MessageApi.MessageListener{
    ...
    private com.example.abehiroe.boko7.MySurfaceView3 mSurfaceView3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSurfaceView3 = (com.example.abehiroe.boko7.MySurfaceView3) findViewById(R.id.surfaceView3_main);
...
//        });
    ...
    public void onMessageReceived(MessageEvent messageEvent) {
        ...
        if (SEND_MESSAGES[7].equals(msg)) {
            mSurfaceView3.punch();
            mSoundPool.play(mSE1,1.0f, 1.0f, 0, 0, 1.0f);
        }  else if (SEND_MESSAGES[8].equals(msg)) {
        ...
        } else if (SEND_MESSAGES[11].equals(msg)) {
            mSurfaceView3.hook();
